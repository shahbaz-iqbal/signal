                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box">
                            <h4 class="page-title">Group Chats</h4>
                        </div>
                    </div>
                </div>
                <!-- end page title -->
                            ...
                            <div class="card-body">
                                ...
                                <form class="search-bar mb-3">
                                    <div class="position-relative">
                                        <input type="text" class="form-control form-control-light" placeholder="Groups">
                        ...
                        <div class="card">
                            <div class="card-body py-2 px-3 border-bottom border-light">
                                <div class="media py-1">
                                    ...
                                    <div class="media-body">
                                        <h5 class="mt-0 mb-0 font-15">
                                            <a href="contacts-profile.html" class="text-reset">App Development</a>
                                        </h5>
                            ...
                            <div class="card-body">
                                <ul class="conversation-list" data-simplebar style="max-height: 460px">
                                    ...
                                    <li class="clearfix odd">
                                        <div class="chat-avatar">
                                            <img src="{{ asset('/') }}assets/images/user.jpg" class="rounded" alt="Geneva M" />
                                            <i>10:01</i>
                                        </div>
                                        <div class="conversation-text">
                                            <div class="ctext-wrap">
                                    ...
                                    <li class="clearfix">
                                        <div class="chat-avatar">
                                            <img src="{{ asset('/') }}assets/images/user.jpg" alt="James Z" class="rounded" />
                                            <i>10:02</i>
                                        </div>
                                        <div class="conversation-text">
                                            <div class="ctext-wrap">
                                    ...
                                    <li class="clearfix odd">
                                        <div class="chat-avatar">
                                            <img src="{{ asset('/') }}assets/images/user.jpg" alt="Geneva M" class="rounded" />
                                            <i>10:03</i>
                                        </div>
                                        <div class="conversation-text">
                                            <div class="ctext-wrap">
