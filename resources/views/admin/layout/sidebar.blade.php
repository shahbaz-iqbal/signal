        ...
        <div class="tab-content pt-0">
            ...
            <div class="tab-pane active" id="settings-tab" role="tabpanel">
                ...
                <div class="p-3">
                    ...
                    <div class="custom-control custom-switch mb-1">
                        <input type="radio" class="custom-control-input" name="color-scheme-mode"
                            value="light" id="light-mode-check"  />
                    ...
                    <!-- Menu positions -->
                    {{-- <h6 class="font-weight-medium font-14 mt-4 mb-2 pb-1">Menus (Leftsidebar and Topbar)
                        Positon</h6>
                ...
                <div class="custom-control custom-switch mb-1">
                    ...
                    <button class="btn btn-primary btn-block mt-4" id="resetBtn">Reset to
                        Default</button> --}}
