...
!function ($) {
    ...
    LeftSidebar.prototype.changeColor = function(color) {
        localStorage.setItem("modeSidebar", color);
...
function ($) {
    ...
    */
    ...
    LayoutThemeApp.prototype.loadConfig = function() {
        ...
        var modeSidebar = localStorage.getItem("modeSidebar")
    ...
    LayoutThemeApp.prototype.changeMode = function(mode) {
        ...
        switch (mode) {
            case "dark": {
                ...
                this._saveConfig({ mode: 'dark', sidebar: $.extend({}, this.config.sidebar, { color: 'dark' }) });
            ...
            default: {
                ...
                this._saveConfig({ mode: 'light', sidebar: $.extend({}, this.config.sidebar, { color: 'light' }) });
    ...
    LayoutThemeApp.prototype.changeLayoutWidth = function(width) {
        switch (width) {
            case "boxed": {
                ...
                localStorage.setItem("width", "boxed");
                break;
            }
            default: {
